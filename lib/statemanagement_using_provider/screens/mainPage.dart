...
import 'package:practice/statemanagement_using_provider/provider/movieProvider.dart';
import 'package:practice/statemanagement_using_provider/screens/wishListPage.dart';
      ...
      body: Column(
        children: [
          ElevatedButton.icon(onPressed: ()=>
              ...
              label: Text("Go To Wishlist ${wishmovies.length}")),
